...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".Partners__header{font-family:\"Roboto\",sans-serif;font-weight:300;color:#fff;text-align:center;font-size:14px;line-height:18px}.Partners__header a{padding:12px 25px;display:flex;justify-content:center}.Partners__part{display:flex}.Partners__part span{flex-shrink:0}.Partners__header img{width:auto;height:16px;margin-top:1px;display:block;margin-left:8px;margin-right:8px}.Partners--hidden{display:none}.Partners__header strong{font-weight:500 !important}@media screen and (max-width: 600px){.Partners__header a{flex-flow:column}.Partners__part{justify-content:center}.Partners__header span{padding:6px 0px}.Partners__part span{padding:0px !important}}", "",{"version":3,"sources":["webpack://src/Partners.scss"],"names":[],"mappings":"AAGA,kBACC,+BAAA,CACA,eAAA,CAEA,UAAA,CACA,iBAAA,CACA,cAAA,CACA,gBAAA,CAED,oBACC,iBAAA,CACA,YAAA,CACA,sBAAA,CAED,gBACC,YAAA,CAED,qBACC,aAAA,CAED,sBACC,UAAA,CACA,WAAA,CACA,cAAA,CACA,aAAA,CACA,eAAA,CACA,gBAAA,CAED,kBACC,YAAA,CAED,yBACC,0BAAA,CAGD,qCACC,oBACC,gBAAA,CAED,gBACC,sBAAA,CAED,uBACC,eAAA,CAED,qBACC,sBAAA,CAAA","sourcesContent":[".Partners__container {\n\n}\n.Partners__header {\n\tfont-family: 'Roboto', sans-serif;\n\tfont-weight: 300;\n\t\n\tcolor: #fff; \n\ttext-align:center;\n\tfont-size: 14px;\n\tline-height: 18px;\n}\n.Partners__header a {\n\tpadding: 12px 25px; \n\tdisplay: flex;\n\tjustify-content: center;\n}\n.Partners__part {\n\tdisplay: flex;\n}\n.Partners__part span {\n\tflex-shrink: 0;\n}\n.Partners__header img {\n\twidth: auto;\n\theight: 16px;\n\tmargin-top: 1px;\n\tdisplay: block;\n\tmargin-left: 8px;\n\tmargin-right: 8px;\n}\n.Partners--hidden {\n\tdisplay: none;\n}\n.Partners__header strong {\n\tfont-weight: 500 !important;\n}\n\n@media screen and (max-width: 600px) {\n\t.Partners__header a {\n\t\tflex-flow: column;\n\t}\n\t.Partners__part {\n\t\tjustify-content: center;\n\t}\n\t.Partners__header span {\n\t\tpadding: 6px 0px;\n\t}\n\t.Partners__part span {\n\t\tpadding: 0px !important;\n\t}\n}"],"sourceRoot":""}]);
// Exports
...
// EXTERNAL MODULE: ./src/Partners.scss
var Partners = __webpack_require__(1);

// CONCATENATED MODULE: ./src/Partners.js
class Partners_Partners {
	constructor () {
		this.attached = false
		this.partners = []
		this.template = `
...
/* harmony default export */ var src_Partners = (Partners_Partners);
